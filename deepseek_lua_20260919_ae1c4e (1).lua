...
function val3:CreateWindow(p13)
  ...
  -- ✅ BIGGER MAIN FRAME (was 380x280 → now 520x400)
  ...
  object:Create("TextLabel", {
    Name = "Title", Parent = create5, BackgroundTransparency = 1, Position = UDim2.new(0, 10, 0, 4), Size = UDim2.new(0.6, 0, 0, 20), Font = default.Font, Text = name, TextColor3 = default.Accent, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, })

  object:Create("TextLabel", {
    Name = "Subtitle", Parent = create5, BackgroundTransparency = 1, Position = UDim2.new(0, 10, 0, 24), Size = UDim2.new(0, 0.6, 0, 14), Font = default.Font, Text = subtitle .. " | " .. version, TextColor3 = default.TextMuted, TextSize = 10, TextXAlignment = Enum.TextXAlignment.Left, })

  local create6 = object:Create("TextButton", {
    Name = "Close", Parent = create5, BackgroundColor3 = default.Element, BackgroundTransparency = default.ElementTransparency, Position = UDim2.new(1, -32, 0.5, -14), Size = UDim2.new(0, 26, 0, 26), Font = default.Font, Text = "X", TextColor3 = default.TextDark, TextSize = 12, AutoButtonColor = false, }, {
  ...
  local create8 = object:Create("ImageButton", {
    Name = "ToggleUI", Parent = create2, BackgroundColor3 = default.Background, Position = UDim2.new(0, 20, 0.5, -25), Size = UDim2.new(0, 50, 0, 50), Image = "rbxassetid://72547915216229", Visible = false, }, {
  ...
  -- ✅ ADJUSTED CONTENT AREA FOR TALLER HEADER
  ...
  -- ✅ WIDER TAB LIST (was 100 → now 130)
  ...
  -- ✅ ADJUSTED MAIN CONTENT OFFSET (was 106 → now 136)
