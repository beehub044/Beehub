...
function val3:CreateWindow(p13)
  ...
  local name = element2.Name or "BEE HUB 🐝🍯"
  local subtitle = element2.Subtitle or "By renehubs"
  local version = element2.Version or "val2.0"
  ...
  local create8 = object:Create("ImageButton", {
    Name = "ToggleUI", Parent = create2, BackgroundColor3 = default.Background, Position = UDim2.new(0, 20, 0.5, -25), Size = UDim2.new(0, 50, 0, 50), Image = "rbxassetid://115299222193858", Visible = false, }, {
...
local reneBaterboniaWindow = val3:CreateWindow({
  Name = "BEE HUB 🐝🍯", Subtitle = "By renehubs", Version = "val2.0", })
...
ownerTab:CreateButton("Tiktok - renehubs.rblx", function(p28)
  helper3("renehubs.rblx", p28, "Tiktok - renehubs.rblx")
end)

ownerTab:CreateButton("Discord", function(p29)
  helper3("https://discord.gg/cDB53Zm6g", p29, "Discord")
end)

ownerTab:CreateButton("Promoter: Kierb_08", function(p30)
  helper3("Kierb_08", p30, "Promoter: Kierb_08")
end)

ownerTab:CreateButton("Promoter - syuta0666", function(p31)
  helper3("syuta0666", p31, "Promoter - syuta0666")
end)
